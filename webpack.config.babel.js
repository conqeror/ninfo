...
module.exports = {
	...
	resolve: {
		...
		alias: {
			components: path.resolve(__dirname, "frontend/components"),    // used for tests
	...
	module: {
		rules: [
			...
			},
			{
				...
				test: /\.(less|css)$/,
				include: [path.resolve(__dirname, 'frontend/components')],
			...
			{
				test: /\.(less|css)$/,
				exclude: [path.resolve(__dirname, 'frontend/components')],
				use: ExtractTextPlugin.extract({
					fallback: 'style-loader',
					use: [
						{
